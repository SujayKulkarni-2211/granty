...
SMTP_PORT = 587
EMAIL_ADDRESS = os.getenv('EMAIL_ADDRESS', 'sujaykulkarni2211@gmail.com')
EMAIL_PASSWORD = os.getenv('EMAIL_PASSWORD', 'vtuh omxp pzpy ctej')
